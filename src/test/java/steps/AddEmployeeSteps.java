...
public class AddEmployeeSteps  extends CommonMethods {
    ...
    public void user_enters_firstname_and_lastname() {
       ...
       // lastNameField.sendKeys("arewell");
        sendText("arewell",addEmployeePage.lastNameField);
    ...
    public void user_adds_multiple_employees_using_excel_from_and_verify_it(String sheetName) throws InterruptedException {
       ...
       List<Map<String,String>> newEmployee= ExcelReader.read(sheetName, Constant.EXCEL_READER_PATH);

        Iterator<Map<String,String>> itr=newEmployee.iterator();

        while(itr.hasNext()){
      // in this map, we have data from every single employee one by one it will give
